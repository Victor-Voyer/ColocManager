 ...
 *
 * Une ligne par membre concerné (payeur inclus). Par défaut, le montant
 * total est réparti également entre les membres dont `amountOwed` est
 * omis ; le créateur peut renseigner un montant précis pour un membre
 * afin de sortir du calcul automatique. La somme des montants doit rester
 * égale au montant total (règle 5).
 */
