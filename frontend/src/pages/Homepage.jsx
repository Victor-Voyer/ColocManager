...
const features = [
  ...
  },
  {
    title: 'Messagerie',
    description:
      'Échangez avec vos colocataires et recevez des notifications instantanées.',
    color: 'purple',
    path: '/messages',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true">
...
const benefits = [
  ...
  {
    title: 'Temps réel',
    text: 'Listes, messages et notifications synchronisés entre tous les membres.',
  },
]
          ...
          <div className="homepage__container homepage__hero-inner">
            <div className="homepage__hero-content">
              ...
              <p className="homepage__subtitle">
                ColocManager centralise vos dépenses, tâches ménagères, listes de courses
                et échanges entre colocataires — le tout dans une interface claire et apaisante.
              </p>
            ...
            <div className="homepage__hero-visual" aria-hidden="true">
              <div className="homepage__dashboard-preview">
                ...
                <div className="homepage__preview-body">
                  ...
                  <div className="homepage__preview-card homepage__preview-card--chat">
                    <span className="homepage__preview-label">Messages</span>
                    <strong>2</strong>
                    <small>Non lus</small>
                  </div>
                </div>
          ...
          <div className="homepage__container">
            <div className="homepage__section-header">
              ...
              <p className="homepage__section-subtitle">
                Quatre modules pensés pour simplifier le quotidien en colocation.
              </p>
            </div>
